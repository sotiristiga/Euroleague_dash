...
st.set_page_config(layout='wide', page_title="Players stats by Team", page_icon="🏀")
...
player_stats_by_team_team = st.sidebar.selectbox("Choose Team:",
...
if "All" in player_stats_by_team_ha:
    ...
    All_Seasons2 = All_Seasons.loc[All_Seasons['HA1'].isin(player_stats_by_team_ha)]
    select_ha_player1 = ''
else:
    All_Seasons1 = All_Seasons.loc[All_Seasons['HA'] == player_stats_by_team_ha]
    All_Seasons2 = All_Seasons.loc[All_Seasons['HA1'] == player_stats_by_team_ha]
    select_ha_player1 = player_stats_by_team_ha

if "All" in player_stats_by_team_season:
    player_stats_by_team_season = ['2016-2017', '2017-2018', '2018-2019', '2019-2020', '2020-2021', '2021-2022',
                                   '2022-2023', '2023-2024', '2024-2025']
    All_Seasons1 = All_Seasons1.loc[All_Seasons1['Season'].isin(player_stats_by_team_season)]
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Season'].isin(player_stats_by_team_season)]
    select_season_player1 = ''
else:
    All_Seasons1 = All_Seasons1.loc[All_Seasons1['Season'] == player_stats_by_team_season]
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Season'] == player_stats_by_team_season]
...
if "All" in player_stats_by_team_wl:
    ...
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Result1'].isin(player_stats_by_team_wl)]
    select_wl_player1 = ''
else:
    All_Seasons1 = All_Seasons1.loc[All_Seasons1['results'] == player_stats_by_team_wl]
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Result1'] == player_stats_by_team_wl]
...
if "All" in player_stats_by_team_phase:
    ...
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Phase'].isin(player_stats_by_team_phase)]
    select_phase_player1 = ''
else:
    All_Seasons1 = All_Seasons1.loc[All_Seasons1['Phase'] == player_stats_by_team_phase]
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Phase'] == player_stats_by_team_phase]
    select_phase_player1 = player_stats_by_team_phase

if "All" in player_stats_by_team_round:
    player_stats_by_team_round = ['First Round', 'Second Round', 'PI 1', 'PI 2', 'PO 1', 'PO 2', 'PO 3', 'PO 4', 'PO 5',
                                  'Semi Final', 'Third Place', 'Final']
    All_Seasons1 = All_Seasons1.loc[All_Seasons1['Round'].isin(player_stats_by_team_round)]
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Round'].isin(player_stats_by_team_round)]
    select_round_player1 = ''
else:
    All_Seasons1 = All_Seasons1.loc[All_Seasons1['Round'] == player_stats_by_team_round]
    All_Seasons2 = All_Seasons2.loc[All_Seasons2['Round'] == player_stats_by_team_round]
...
with opponentplayers:
    interactive_table(compute_player_stats_by_team_against(All_Seasons2, player_stats_by_team_team),
                      paging=False, height=960, width=20000, showIndex=True,
