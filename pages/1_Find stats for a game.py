...
st.set_page_config(layout='wide',page_title="Find stats for a game",page_icon="🏀")
...
home_team=(All_Seasons_results[['Fixture',"Phase","Home","Away","Home_Points","Away_Points",
                                "Q1H","Q2H","Q3H","Q4H",'EXH',"Q1A","Q2A","Q3A","Q4A",'EXA','Season','Round']]
           .rename(columns={"Home":'Team',"Away":'Against',"Home_Points":'Scored',"Away_Points":"Conceed",
                            ...
                            "Q2A":'Q2C',"Q3A":'Q3C',"Q4A":'Q4C','EXA':'EXC'}))
...
away_team=(All_Seasons_results[['Fixture',"Phase","Home","Away","Home_Points","Away_Points",
           ...
           .rename(columns={"Home":'Against',"Away":'Team',"Home_Points":'Conceed',"Away_Points":"Scored",
                            ...
                            "Q2A":'Q2S',"Q3A":'Q3S',"Q4A":'Q4S','EXA':'EXS'}))
away_team['HA']="A"
...
search_season=st.sidebar.selectbox("Season:",['2016-2017', '2017-2018', '2018-2019', '2019-2020', '2020-2021','2021-2022', '2022-2023', '2023-2024','2024-2025','2025-2026'],index=9)
                 ...
                 .rename(columns={"F2GP":'2P(%)',
                               ...
                               "FTP":'FT(%)',
                                'Offensive_rating':'Offensive Rating',
                                  ...
                                  'Usage':'USG(%)',
                                  'OR_percent':'OR(%)',
                                  "results":'Result'}).set_index('Player').sort_values('HA',ascending=False))
...
finalstats=All_Seasons_season_fixture_sel.groupby(['Team','HA'])[['PTS','F2M',
                              ...
                              'PIR','Possesions']].sum().reset_index().sort_values('HA',ascending=False)

finalstats.drop('HA',axis=1,inplace=True)
...
finalstats=finalstats[['Team','PTS','F2M','F2A', '2P(%)','F3M', 'F3A','3P(%)', 'FTM', 'FTA','FT(%)', 'OR','DR', 'TR',
                       ...
                       'TS(%)','FT Ratio','AS-TO Ratio','TO Ratio','AS Ratio']].round(2)
...
st.write("##### Team Stats")
interactive_table(finalstats.set_index('Team'),
