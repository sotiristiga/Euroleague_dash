...
if "All" in selected_round_player1:
    selected_round_player1 = ['First Round', 'Second Round', 'PI 1', 'PI 2', 'PO 1', 'PO 2', 'PO 3', 'PO 4', 'PO 5',
...
All_Seasons_filter['Player(Team)'] = All_Seasons_filter['Player'] + " (" + All_Seasons_filter['Team'] + "," + \
                                     All_Seasons_filter['Season'] + " vs " + All_Seasons_filter['Against'] + ")"
All_Seasons_filter.rename(
    columns={'PTS': 'Points', 'F2M': '2P Made', 'F3M': '3P Made', 'F2A': '2P Attempt', "F2GP": "2P%",
             'F3A': '3P Attempt', "F3GP": "3P%", 'FTM': 'FT Made', 'FTA': 'FT Attempt', "FTP": "FT%",
             'OR': 'Offensive Rebounds', 'DR': 'Defensive Rebounds',
             'TR': 'Total Rebounds', 'AS': 'Assists', 'ST': 'Steals', 'TO': "Turnovers", 'BLK': "Blocks Made",
             'BLKR': 'Blocks Reversed', 'PF': 'Personal Fouls', 'RF': 'Fouls Drawn'}, inplace=True)
All_Seasons.rename(
    columns={'PTS': 'Points', 'F2M': '2P Made', 'F3M': '3P Made', 'F2A': '2P Attempt', 'F3A': '3P Attempt',
             'FTM': 'FT Made', 'FTA': 'FT Attempt', 'OR': 'Offensive Rebounds', 'DR': 'Defensive Rebounds',
             'TR': 'Total Rebounds', 'AS': 'Assists', 'ST': 'Steals', 'TO': "Turnovers", 'BLK': "Blocks Made",
             'BLKR': 'Blocks Reversed', 'PF': 'Personal Fouls', 'RF': 'Fouls Drawn'}, inplace=True)
All_Seasons_filter_sel = All_Seasons_filter[
    ["Player(Team)", 'Points', 'MIN', '2P Made', '2P Attempt', '3P Made', '3P Attempt', 'FT Made', 'FT Attempt',
     'Offensive Rebounds', 'Defensive Rebounds', 'Total Rebounds',
     'Assists', 'Steals', 'Turnovers', 'Blocks Made', 'Blocks Reversed', 'Personal Fouls', 'Fouls Drawn', "PIR", '2P%',
     '3P%', 'FT%']]
All_Seasons_filter_sel['2P Made(%)'] = All_Seasons_filter_sel['2P Made'].astype(str) + " (" + All_Seasons_filter_sel[
    '2P%'].round(1).astype(str) + "%)"
All_Seasons_filter_sel['2P Attempt(%)'] = All_Seasons_filter_sel['2P Attempt'].astype(str) + " (" + \
                                          All_Seasons_filter_sel['2P%'].round(1).astype(str) + "%)"
All_Seasons_filter_sel['3P Made(%)'] = All_Seasons_filter_sel['3P Made'].astype(str) + " (" + All_Seasons_filter_sel[
    '3P%'].round(1).astype(str) + "%)"
All_Seasons_filter_sel['3P Attempt(%)'] = All_Seasons_filter_sel['3P Attempt'].astype(str) + " (" + \
                                          All_Seasons_filter_sel['3P%'].round(1).astype(str) + "%)"
All_Seasons_filter_sel['FT Made(%)'] = All_Seasons_filter_sel['FT Made'].astype(str) + " (" + All_Seasons_filter_sel[
    'FT%'].round(1).astype(str) + "%)"
All_Seasons_filter_sel['FT Attempt(%)'] = All_Seasons_filter_sel['FT Attempt'].astype(str) + " (" + \
                                          All_Seasons_filter_sel['FT%'].round(1).astype(str) + "%)"
compute_player_mean_stats = All_Seasons_filter.groupby('Player')[
    ['Points', 'MIN', '2P Made', '2P Attempt', '3P Made', '3P Attempt', 'FT Made', 'FT Attempt', 'Offensive Rebounds',
     ...
     'Team_PTS', 'Team_F2M', 'Team_F2A', 'Team_F3M', 'Team_F3A', 'Team_FTM', 'Team_FTA', 'Team_OR', 'Team_DR',
     'Team_TR', 'Team_AS', 'Team_ST', 'Team_TO', 'Team_BLK', 'Team_PF', 'Team_opp_PTS', 'Team_opp_F2M', 'Team_opp_F2A',
...
compute_player_total_stats = All_Seasons_filter.groupby('Player')[
    ['Points', 'MIN', '2P Made', '2P Attempt', '3P Made', '3P Attempt', 'FT Made', 'FT Attempt', 'Offensive Rebounds',
     ...
     'Assists', 'Steals', 'Turnovers', 'Blocks Made', 'Blocks Reversed', 'Personal Fouls', 'Fouls Drawn', 'PIR',
     'Team_PTS', 'Team_F2M', 'Team_F2A', 'Team_F3M', 'Team_F3A', 'Team_FTM', 'Team_FTA', 'Team_OR', 'Team_DR',
     'Team_TR', 'Team_AS', 'Team_ST', 'Team_TO', 'Team_BLK', 'Team_PF', 'Team_opp_PTS',
...
compute_player_mean_stats_season = All_Seasons.groupby(['Player', 'Season'])[
    ['Points', 'MIN', '2P Made', '2P Attempt', '3P Made', '3P Attempt', 'FT Made', 'FT Attempt', 'Offensive Rebounds',
     'Defensive Rebounds', 'Total Rebounds',
     'Assists', 'Steals', 'Turnovers', 'Blocks Made', 'Blocks Reversed', 'Personal Fouls', 'Fouls Drawn', 'PIR',
     'Team_PTS', 'Team_F2M', 'Team_F2A', 'Team_F3M', 'Team_F3A', 'Team_FTM', 'Team_FTA', 'Team_OR', 'Team_DR',
...
compute_player_mean_stats_season = pd.merge(compute_player_mean_stats_season, compute_player_games_season,
                                            on=['Player', 'Season'])
compute_player_mean_stats_season['Player'] = compute_player_mean_stats_season['Player'] + " (" + \
                                             compute_player_mean_stats_season['Season'] + ")"
compute_player_total_stats_season = All_Seasons_filter.groupby(['Player', 'Season'])[
    ['Points', 'MIN', '2P Made', '2P Attempt', '3P Made', '3P Attempt', 'FT Made', 'FT Attempt', 'Offensive Rebounds',
     'Defensive Rebounds', 'Total Rebounds',
     'Assists', 'Steals', 'Turnovers', 'Blocks Made', 'Blocks Reversed', 'Personal Fouls', 'Fouls Drawn',
     'PIR']].sum().reset_index()

compute_player_total_stats_season = (compute_player_total_stats_season.add_prefix('Total_')).rename(
    columns={'Total_Player': 'Player', 'Total_Season': 'Season'})
compute_player_total_stats_season = pd.merge(compute_player_total_stats_season, compute_player_games_season,
                                             on=['Player', 'Season'])
compute_player_mean_stats_season = compute_player_mean_stats_season.loc[compute_player_mean_stats_season['Games'] > 15]

f6, f7 = st.columns(2)
with f6:
    basicstatselect = st.selectbox('Select Stat:',
                                   ['Points', "Assists", "Total Rebounds", "Offensive Rebounds", 'Defensive Rebounds',
                                    "Steals", 'Turnovers', 'Blocks Made', 'Blocks Reversed',
                                    'Personal Fouls', "Fouls Drawn", 'PIR', '2P Made', "2P Attempt", '3P Made',
                                    "3P Attempt", 'FT Made', "FT Attempt",
                                    'Possesions', "Offensive Rating", "EFG%", 'TS%', "FT Ratio", "AS-TO ratio",
                                    'TO Ratio',
                                    "AS Ratio", "USG%", 'OR%'])
with f7:
    games = st.slider("Pick Number of games", 0, 200, value=0)

regex1 = 'Player|' + basicstatselect

st.header("Average Stats")
st.write("##### Average " + basicstatselect + " per game in Euroleague (Top 10)")
st.write('(For better results move the Games slider)')

av = compute_player_mean_stats.loc[compute_player_mean_stats['Games'] > games].filter(regex=regex1).sort_values(
    basicstatselect,
...
st.write(
    "##### Best by Season on avg. " + basicstatselect + " in Euroleague (Top 10 - played at least 15 games in the season)")
