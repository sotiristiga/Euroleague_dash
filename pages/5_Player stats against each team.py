...
st.set_page_config(layout='wide',page_title="Player stats against each team")
...
player_stats_by_team_ha = st.sidebar.selectbox("Home or Away games(of Team):",['A', 'H', 'All'],index=2)
...
player_stats_by_team_wl = st.sidebar.selectbox("Result(of Team):",['W', 'L','All'],index=2)
